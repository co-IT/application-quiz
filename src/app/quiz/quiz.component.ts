...
export class QuizComponent {
  ...
  constructor(private ar:ActivatedRoute,private questionService:QuestionsService,private router:Router,private timerService:TimerService) {
   ...
   /**function to update checkbox' selcted values */
